...
source/%.o: ../source/%.cpp
	...
	/usr/local/cuda-8.0/bin/nvcc -I../frameserver/header -I../frameserver/communications -I../../../Programs/NVIDIA-OptiX-SDK-5.0.1-linux64/include -I../../../Programs/include -O3 -std=c++11 -gencode arch=compute_35,code=sm_35 -gencode arch=compute_60,code=sm_60  -odir "source" -M -o "$(@:%.o=%.d)" "$<"
